...
public class BlockGlowstoneTorch extends Block implements ITANBlock {
	 ...
	 * 
	 * @Override public void randomDisplayTick(IBlockState stateIn, World
	 * worldIn, BlockPos pos, Random rand) { EnumFacing enumfacing =
	 * (EnumFacing)stateIn.getValue(FACING); double d0 = (double)pos.getX() +
	 * 0.5D; double d1 = (double)pos.getY() + 0.7D; double d2 =
	 * (double)pos.getZ() + 0.5D; double d3 = 0.22D; double d4 = 0.27D;
	 * 
	 ...
	 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 *
	 * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D, new int[0]);
	 * worldIn.spawnParticle(EnumParticleTypes.FLAME, d0 + d4 *
	 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 *
	 * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D, new int[0]); }
	 * else { worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0, d1, d2,
	 * 0.0D, 0.0D, 0.0D, new int[0]);
	 * worldIn.spawnParticle(EnumParticleTypes.FLAME, d0, d1, d2, 0.0D, 0.0D,
	 * 0.0D, new int[0]); } }
	 */
