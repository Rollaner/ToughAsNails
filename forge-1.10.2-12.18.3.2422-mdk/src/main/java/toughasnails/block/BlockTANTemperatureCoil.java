...
public class BlockTANTemperatureCoil extends BlockContainer implements ITANBlock {
	...
	public BlockTANTemperatureCoil() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, CoilType.COOLING)
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(VARIANT, CoilType.values()[meta & 1]).withProperty(POWERED,
	...
	public int damageDropped(IBlockState state) {
		return ((CoilType) state.getValue(VARIANT)).ordinal(); // Always drop
																// the unpowered
																// version
	}
