...
public class ItemFruitJuice extends ItemDrink<JuiceType> {
	...
	public static enum JuiceType implements IDrink,IStringSerializable {
		APPLE(8, 0.8F), BEETROOT(10, 0.8F), CACTUS(9, 0.2F), CARROT(8,
				0.6F), CHORUS_FRUIT(12, 0.6F), GLISTERING_MELON(16,
						1.0F), GOLDEN_APPLE(20, 1.2F), GOLDEN_CARROT(14,
								1.0F), MELON(8, 0.5F), PUMPKIN(7, 0.7F);
