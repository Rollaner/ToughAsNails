...
public class ItemTANSpawnEgg extends Item implements IColoredItem {
	...
	public IItemColor getItemColor() {
		return new IItemColor() {
			...
			public int getColorFromItemstack(ItemStack stack, int tintIndex) {
				EntityList.EntityEggInfo entityegginfo = ModEntities.entityEggs
						.get(Integer.valueOf(stack.getMetadata()));
				return entityegginfo != null
						? (tintIndex == 0 ? entityegginfo.primaryColor : entityegginfo.secondaryColor) : 16777215;
			}
		};
	}
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos,
		...
		if (worldIn.isRemote) {
			...
			if (iblockstate.getBlock() == Blocks.MOB_SPAWNER) {
				...
				if (tileentity instanceof TileEntityMobSpawner) {
					...
					mobspawnerbaselogic.setEntityName(
							EntityList.CLASS_TO_NAME.get(EntityList.getClassFromID(stack.getMetadata())));
			...
			Entity entity = spawnTANCreature(worldIn, stack.getMetadata(), (double) pos.getX() + 0.5D,
