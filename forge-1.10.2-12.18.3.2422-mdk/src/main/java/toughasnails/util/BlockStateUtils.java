...
public class BlockStateUtils {
	...
	// returns a set of states, one for every possible combination of values
	...
	// works by looping through all the different values of the properties
	// specified in block.getPresetProperties()
	// only works on blocks supporting IBOPBlock - returns an empty set for
	// vanilla blocks
	...
	/**
	 * Discards additional block information to retrieve a state equivalent to
