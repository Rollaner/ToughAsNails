...
public class BiomeModifier extends TemperatureModifier {
	...
	public Temperature modifyTarget(World world, BlockPos position,
		...
		Biome biomeNorth = world.getBiome(position.add(0, 0, -10));
		Biome biomeSouth = world.getBiome(position.add(0, 0, 10));
		Biome biomeEast = world.getBiome(position.add(10, 0, 0));
		Biome biomeWest = world.getBiome(position.add(-10, 0, 0));
